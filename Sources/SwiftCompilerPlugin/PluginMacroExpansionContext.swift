...
/// Manages source code combined with their filename/fileID. This can be used to
/// get line/column from a syntax node in the managed source code.
class SourceManager {
  ...
  var knownSourceSyntax: [Syntax.ID: KnownSourceSyntax] = [:]
...
extension PluginMacroExpansionContext: MacroExpansionContext {
  ...
  public func location<Node: SyntaxProtocol>(
    ...
    return sourceManger.location(
      of: Syntax(node), at: positionMode, filePathMode: filePathMode)
  }
}
